...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "body{\n  background: rgb(237, 237, 238);\n}\n\n#content-container {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n}\n\n.gridContainer1{\n  display: grid;\n  grid-template-rows: repeat(10, 1fr);\n  grid-template-columns: repeat(10, 1fr);\n  background-color: rgb(125, 125, 196);\n  height: 500px;\n  width: 500px;\n  border: 1px solid black;\n}\n\n.gridContainer2{\n  display: grid;\n  grid-template-rows: repeat(10, 1fr);\n  grid-template-columns: repeat(10, 1fr);\n  background-color: rgb(125, 125, 196);\n  height: 500px;\n  width: 500px;\n  border: 1px solid black;\n}\n\n.grid-square{\n  border: 1px solid black;\n}\n\nform{\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n\n}\n\n\n\n.name-title {\n  display: inline-block;\n  font-size: 55px;\n  color: #000;\n  font-family: 'Oswald', sans-serif;\n  margin-bottom: 2rem;\n}\n\n#capt-info{\n  border: 2px solid black;\n  padding: 15px 150px 15px 150px;\n  font-size: 35px;\n  font-weight: normal;\n  border-radius: 20px;\n  background: rgb(255, 255, 255);\n  margin-bottom: 2rem;\n\n\n}\n\n.btns{\n  padding: 10px;\n  font-weight: bold;\n  background-color: white;\n  outline: none;\n  font-size: 15px;\n  border:none;\n}\n\n.btns:hover{\n  background-color: rgb(237, 248, 255);\n  cursor: pointer;\n}\n\n.hidden{\n  display: none;\n}\n\n.modal {\n  position: absolute;\n  top: 50%;\n  left: 50%;\n  transform: translate(-50%, -50%);\n  width: 30%;\n  padding: 0rem 3rem 3rem 3rem;\n  border-radius: 20px;\n  box-shadow: 0 3rem 5rem rgba(0, 0, 0, 0.3);\n  z-index: 10;\n  border: 1px solid black;\n  width: 30%;\n  height: 33%;\n  background: rgb(255, 255, 255);\n\n}\n\n#rules-title{\n  display: flex;\n  justify-content: center;\n  width: 100%;\n}\n\n.close-modal{\n  position: absolute;\n  top: 1.2rem;\n  right: 2rem;\n  font-size: 2rem;\n  color: rgb(0, 0, 0);\n  cursor: pointer;\n  border: none;\n  background: none;\n  outline: none;\n\n\n}\n\n.close-modal:hover{\n  outline: none;\n}\n\np{\n text-align: center;\n font-size: 18px;\n}\n\n#enterYourName{\n  padding: 15px 70px 15px 70px;\n  width: 100%;\n  border-radius: 20px;\n  outline: none;\n  font-size: 20px;\n  text-align: center;\n\n}\n\n#submitBtn {\n  font-size: 25px;\n  font-weight: bolder;\n  padding: 15px;\n  cursor: pointer;\n}\n\n.playerNameContainer{\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n}\n\n.nameOnShips{\n  display: flex;\n  width: 100%;\n  justify-content: center;\n  justify-content: space-around;\n}\n\n#playerNameHeader, #enemyWaters{\n  width: 100%;\n  background-color: black;\n  color: white;\n  text-align: center;\n  padding: 1rem 0rem 1rem 0rem;\n  font-weight: bold;\n  font-size: 2rem;\n  margin-bottom: 5px;\n  height: 37px;\n}\n\n#btns-container{\n  margin-bottom: 2rem;\n}\n", "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;EACE,8BAA8B;AAChC;;AAEA;EACE,aAAa;EACb,sBAAsB;EACtB,mBAAmB;AACrB;;AAEA;EACE,aAAa;EACb,mCAAmC;EACnC,sCAAsC;EACtC,oCAAoC;EACpC,aAAa;EACb,YAAY;EACZ,uBAAuB;AACzB;;AAEA;EACE,aAAa;EACb,mCAAmC;EACnC,sCAAsC;EACtC,oCAAoC;EACpC,aAAa;EACb,YAAY;EACZ,uBAAuB;AACzB;;AAEA;EACE,uBAAuB;AACzB;;AAEA;EACE,aAAa;EACb,sBAAsB;EACtB,mBAAmB;;AAErB;;;;AAIA;EACE,qBAAqB;EACrB,eAAe;EACf,WAAW;EACX,iCAAiC;EACjC,mBAAmB;AACrB;;AAEA;EACE,uBAAuB;EACvB,8BAA8B;EAC9B,eAAe;EACf,mBAAmB;EACnB,mBAAmB;EACnB,8BAA8B;EAC9B,mBAAmB;;;AAGrB;;AAEA;EACE,aAAa;EACb,iBAAiB;EACjB,uBAAuB;EACvB,aAAa;EACb,eAAe;EACf,WAAW;AACb;;AAEA;EACE,oCAAoC;EACpC,eAAe;AACjB;;AAEA;EACE,aAAa;AACf;;AAEA;EACE,kBAAkB;EAClB,QAAQ;EACR,SAAS;EACT,gCAAgC;EAChC,UAAU;EACV,4BAA4B;EAC5B,mBAAmB;EACnB,0CAA0C;EAC1C,WAAW;EACX,uBAAuB;EACvB,UAAU;EACV,WAAW;EACX,8BAA8B;;AAEhC;;AAEA;EACE,aAAa;EACb,uBAAuB;EACvB,WAAW;AACb;;AAEA;EACE,kBAAkB;EAClB,WAAW;EACX,WAAW;EACX,eAAe;EACf,mBAAmB;EACnB,eAAe;EACf,YAAY;EACZ,gBAAgB;EAChB,aAAa;;;AAGf;;AAEA;EACE,aAAa;AACf;;AAEA;CACC,kBAAkB;CAClB,eAAe;AAChB;;AAEA;EACE,4BAA4B;EAC5B,WAAW;EACX,mBAAmB;EACnB,aAAa;EACb,eAAe;EACf,kBAAkB;;AAEpB;;AAEA;EACE,eAAe;EACf,mBAAmB;EACnB,aAAa;EACb,eAAe;AACjB;;AAEA;EACE,aAAa;EACb,sBAAsB;EACtB,mBAAmB;AACrB;;AAEA;EACE,aAAa;EACb,WAAW;EACX,uBAAuB;EACvB,6BAA6B;AAC/B;;AAEA;EACE,WAAW;EACX,uBAAuB;EACvB,YAAY;EACZ,kBAAkB;EAClB,4BAA4B;EAC5B,iBAAiB;EACjB,eAAe;EACf,kBAAkB;EAClB,YAAY;AACd;;AAEA;EACE,mBAAmB;AACrB","sourcesContent":["body{\n  background: rgb(237, 237, 238);\n}\n\n#content-container {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n}\n\n.gridContainer1{\n  display: grid;\n  grid-template-rows: repeat(10, 1fr);\n  grid-template-columns: repeat(10, 1fr);\n  background-color: rgb(125, 125, 196);\n  height: 500px;\n  width: 500px;\n  border: 1px solid black;\n}\n\n.gridContainer2{\n  display: grid;\n  grid-template-rows: repeat(10, 1fr);\n  grid-template-columns: repeat(10, 1fr);\n  background-color: rgb(125, 125, 196);\n  height: 500px;\n  width: 500px;\n  border: 1px solid black;\n}\n\n.grid-square{\n  border: 1px solid black;\n}\n\nform{\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n\n}\n\n\n\n.name-title {\n  display: inline-block;\n  font-size: 55px;\n  color: #000;\n  font-family: 'Oswald', sans-serif;\n  margin-bottom: 2rem;\n}\n\n#capt-info{\n  border: 2px solid black;\n  padding: 15px 150px 15px 150px;\n  font-size: 35px;\n  font-weight: normal;\n  border-radius: 20px;\n  background: rgb(255, 255, 255);\n  margin-bottom: 2rem;\n\n\n}\n\n.btns{\n  padding: 10px;\n  font-weight: bold;\n  background-color: white;\n  outline: none;\n  font-size: 15px;\n  border:none;\n}\n\n.btns:hover{\n  background-color: rgb(237, 248, 255);\n  cursor: pointer;\n}\n\n.hidden{\n  display: none;\n}\n\n.modal {\n  position: absolute;\n  top: 50%;\n  left: 50%;\n  transform: translate(-50%, -50%);\n  width: 30%;\n  padding: 0rem 3rem 3rem 3rem;\n  border-radius: 20px;\n  box-shadow: 0 3rem 5rem rgba(0, 0, 0, 0.3);\n  z-index: 10;\n  border: 1px solid black;\n  width: 30%;\n  height: 33%;\n  background: rgb(255, 255, 255);\n\n}\n\n#rules-title{\n  display: flex;\n  justify-content: center;\n  width: 100%;\n}\n\n.close-modal{\n  position: absolute;\n  top: 1.2rem;\n  right: 2rem;\n  font-size: 2rem;\n  color: rgb(0, 0, 0);\n  cursor: pointer;\n  border: none;\n  background: none;\n  outline: none;\n\n\n}\n\n.close-modal:hover{\n  outline: none;\n}\n\np{\n text-align: center;\n font-size: 18px;\n}\n\n#enterYourName{\n  padding: 15px 70px 15px 70px;\n  width: 100%;\n  border-radius: 20px;\n  outline: none;\n  font-size: 20px;\n  text-align: center;\n\n}\n\n#submitBtn {\n  font-size: 25px;\n  font-weight: bolder;\n  padding: 15px;\n  cursor: pointer;\n}\n\n.playerNameContainer{\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n}\n\n.nameOnShips{\n  display: flex;\n  width: 100%;\n  justify-content: center;\n  justify-content: space-around;\n}\n\n#playerNameHeader, #enemyWaters{\n  width: 100%;\n  background-color: black;\n  color: white;\n  text-align: center;\n  padding: 1rem 0rem 1rem 0rem;\n  font-weight: bold;\n  font-size: 2rem;\n  margin-bottom: 5px;\n  height: 37px;\n}\n\n#btns-container{\n  margin-bottom: 2rem;\n}\n"],"sourceRoot":""}]);
// Exports
