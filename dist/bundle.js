...
var creatingDropZone = function creatingDropZone(e) {
...
var getReadyForDropZone = function getReadyForDropZone() {
...
gridSquares.forEach(function (gridSquare) {
  gridSquare.addEventListener('dragend', function (e) {
    var dragging = document.querySelector('.dragging');
...
var displayYaxisBtn = function displayYaxisBtn() {
  var carriersContainer = document.querySelector('.carriers-Container');
